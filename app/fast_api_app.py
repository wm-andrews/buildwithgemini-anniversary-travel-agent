...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    # Runner for the A2A path, sharing session, artifact, and memory services
...
app.title = "anniversary-travel-agent"
app.description = "API for interacting with the Agent anniversary-travel-agent"
